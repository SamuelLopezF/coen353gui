...
<body>
  ...
  <h3>GET</h3>
  <form action="./queries/crud_relatives/get_person.php" method="GET">
    MEDICARE: <input type="number" name="medicare_get_id" id="medicare_get_id" value="">
    <input type="submit" value="GET"> 
  </form>
  <h3>INSERT</h3>
  <form action="./queries/crud_relatives/insert_person.php" method="POST">
  ...
  <h3>UPDATE</h3>
  <form action="./queries/crud_relatives/update_person1.php" method="POST">
      MEDICARE : <input type="number" name="relatives_medicare_update" id="medicare_id_update" value="">
      <input type="submit" value="UPDATE"> 
  </form>
  <h3>DELETE</h3>
  <form action="./queries/crud_relatives/delete_person.php" method="POST">
