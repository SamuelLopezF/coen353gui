...
$notify_query = "SELECT b.employeeMedicare FROM schedule as a , schedule as b where '".$medicare."' = a.employeeMedicare"
...
try {
  ...
  $remove_schedule_query = "REMOVE FROM schedule WHERE employeeMedicare = ".$medicare.
    " AND date <= ADDDATE('".$date."', INTERVAL 14 DAY)";
