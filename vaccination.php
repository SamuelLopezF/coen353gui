...
<body>
  ...
  <h3>UPDATE</h3>
  <form action="./queries/crud_vaccination/update_vaccination.php" method="POST">
      ...
      PROVIDER: <input type="text" name="city_vaccination_update" id="" value=""></br>
      DOSE NUMBER: <input type="number" name="dose_number_update" id="" value=""></br>
      FACILITY POSTAL CODE : <input type="text" name="postal_code_vaccination_update" id="" value=""></br>
<input type="submit" value="UPDATE"> 
  ...
  <form action="./queries/crud_vaccination/delete_vaccination.php" method="POST">
      ...
      FACILITY POSTAL CODE : <input type="text" name="postal_code_vaccination_delete" id="" value=""></br>
